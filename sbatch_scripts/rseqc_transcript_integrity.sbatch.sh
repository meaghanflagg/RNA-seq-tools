...
tin.py -i $1 -r /n/groups/kwon/data1/databases/human/hg38/gencode_GRCh38/gencode.v28.primary_assembly.annotation.bed > ${OUTFILE}_rseqc_transcript_integrity.txt
